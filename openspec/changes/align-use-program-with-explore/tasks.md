...
- [ ] 1.1 Add failing Program-reference tests for `use_program({"ref": explored.ref, ...})`, JSON-compatible return data and omitted runtime input.
...
- [ ] 3.1 Update CLI Help and Program runtime documentation to make Explore-ref invocation standard and label the name form compatibility-only.
