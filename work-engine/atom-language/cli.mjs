...
function help() {
  ...
  return [
    ...
    '  冷启动：内核从 @program@agent 正文中的 literal agent() 声明重建 labels 与符号职能 scope；侧车 agentRegistrations 稳定返回 RETIRED_AGENT_REGISTRATION_SNAPSHOT，旧 windowSelfLocks/windowSelfLockAgents 稳定返回 RETIRED_WINDOW_SELF_LOCK_SNAPSHOT 并须一次性清退，不保留双权限 ABI。',
