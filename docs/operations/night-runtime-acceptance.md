...
- **Authority receipt**: create a versioned, expiring receipt naming the exact approved Agent, `test` domain, bounded cleanup/restart, publication scope, and unattended setting. It must never slot credentials.
