...
- **Next**: create the local safety commit, verify the formal runtime code boundary, deploy code before data, then run the same operator against production and read back public 4784. The queued Web pointer/crosshair display revision follows this mainline.
