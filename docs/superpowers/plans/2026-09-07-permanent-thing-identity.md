...
- **Next**: complete identity lifecycle across create/copy/archive/restore/slot-body generation, then bind Shortcut/Strut/Slot references before Program literal references. No production migration or deployment is allowed before the cold-copy migration and rollback gates in Task 5 pass.
